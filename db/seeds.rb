...
developer1 = Developer.create(username: "Tom", password: "123", age: 34, experience: 7, studio: "Bethesda")
developer2 = Developer.create(username: "Bob", password: "123", age: 30, experience: 4, studio: "Ensemble Studios")
developer3 = Developer.create(username: "Sally", password: "123", age: 27, experience: 3, studio: "Nintendo Studios")
developer4 = Developer.create(username: "Susie", password: "123", age: 28, experience: 2, studio: "Firaxis Games")
developer5 = Developer.create(username: "Tim", password: "123", age: 31, experience: 5, studio: "Gearbox Software")
developer6 = Developer.create(username: "John", password: "123", age: 39, experience: 7, studio: "Blizzard Entertainment")
developer7 = Developer.create(username: "David", password: "123", age: 33, experience: 4, studio: "Guerilla Games")
